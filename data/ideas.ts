...
export const IDEAS: Idea[] = [
  {
    ...
    category: 'Work',
    date: '2026-05-20',
    body: `In the weeks leading up to shooting "I Fall to Pieces", my newly-appointed cinematographer was a staunch advocate of us shooting the film in ultra-widescreen (aspect ratio 2.39:1). I preferred widescreen (1.85:1).
